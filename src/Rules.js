...
class FullHouse extends Rule {
  // TODO
  // use freq counter built in will return arr of the counts
  // arr length should only be 2 AND either 3 or 2
  evalRoll = dice => {
    const diceCount = this.freq(dice);
    return  diceCount.length === 2 && (diceCount[0] === 2 || diceCount[0] === 3) ? this.score : 0;
  };
}
...
class SmallStraight extends Rule {
  // TODO
  // eval roll create a set in order to remove duplicates
  // return true score if size is greater than or equal 4
  evalRoll = dice => {
